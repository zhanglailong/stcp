...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements ISysRoleService {
	...
	@Override
	public Page<SysRole> rolePageList(Page<SysRole> page, String roleGrouping) {
		return page.setRecords(sysRoleMapper.getRoleList(page, roleGrouping));
	}

	@Override
	public String getRoleGroupingById(String id) {
		return sysRoleMapper.getRoleGroupingById(id);
	}

	@Override
	public String getRoleIdByRoleCode(String roleCode) {
		return sysRoleMapper.getRoleIdByRoleCode(roleCode);
	}

	@Override
	public String getRoleIdByRnp(String roleCode, String projectId) {
		return sysRoleMapper.getRoleIdByRnp(roleCode, projectId);
	}
}
