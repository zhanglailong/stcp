    ...
    public Result<?> upload(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(isUploadToFtp)
        {
            try
            {
                ...
                originalFilename = String.format("%s_%s",System.currentTimeMillis(),originalFilename);
                boolean isUploadOk = ftpUtil.uploadToFtp(file.getInputStream(), originalFilename, false);
        ...
        if(CommonConstant.UPLOAD_TYPE_LOCAL.equals(uploadType)){
            ...
            */
            ...
            if(!isUploadToFtp) {
                savePath = CommonUtils.upload(file, bizPath, uploadType,customBucket);
            }
...
//	}
    ...
    public void view(HttpServletRequest request, HttpServletResponse response) {
        ...
        String sign2="null";
        if(oConvertUtils.isEmpty(imgPath) || imgPath==sign2){
            return;
        }
        // 其余处理略
