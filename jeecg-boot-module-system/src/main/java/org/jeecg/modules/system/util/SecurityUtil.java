...
public class SecurityUtil {
     ...
     * @return
     */
    public static String jiami(String content,String secretKey) {
    ...
    /**
     * 解密
     * @param encryptResultStr 待解密内容
     * @param secretKey 私钥
     * @return
     */
    public static String jiemi(String encryptResultStr,String secretKey){
        SymmetricCrypto aes = new SymmetricCrypto(SymmetricAlgorithm.AES, secretKey.getBytes());
        //解密为字符串
        String decryptResult = aes.decryptStr(encryptResultStr, CharsetUtil.CHARSET_UTF_8);
        return  decryptResult;
