...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    private JSONObject getPermissionJsonObject(SysPermission permission) {
        ...
        int sign=2;
        if(permission.getMenuType()==sign) {
            json.put("action", permission.getPerms());
            json.put("describe", permission.getName());
        }else if(permission.getMenuType()==0||permission.getMenuType()==1) {
            json.put("id", permission.getId());
            boolean flag=permission.getUrl()!=null&&(permission.getUrl().startsWith("http://")||permission.getUrl().startsWith("https://"));
            if(flag) {
            ...
            boolean flag1=permission.getUrl()!=null&&(permission.getUrl().startsWith("http://")||permission.getUrl().startsWith("https://"));
            if(flag1) {
