...
public class JsonschemaUtil {
	 ...
	 * @return
	 */
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<BaseCommonProperty> propertyList) {
		JSONObject obj = new JSONObject();
		obj.put("$schema", descrip.getdschema());
		...
		for (BaseCommonProperty commonProperty : propertyList) {
	 ...
	 * @return
	 */
	public static JSONObject getSubJsonSchema(String title,List<String> requiredArr,List<BaseCommonProperty> propertyList) {
		JSONObject obj = new JSONObject();
		obj.put("type", "object");
		obj.put("view", "tab");
		obj.put("title", title);
