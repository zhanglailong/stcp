...
public interface CommonConstant {
    ...
    /** 工具安装方式*/
    public static final int autoInstall = 1;
    public static final int diyInstall = 2;
    ...
    */
    ...
    /**优先级（L低，M中，H高）*/
    public static final String PRIORITY_L  = "1";
    public static final String PRIORITY_M  = "2";
    public static final String PRIORITY_H  = "3";
    ...
    public static final Integer USER_LOGOUT = 3;  //dq add 对应用户注销状态,注销的用户可通过管理员还原操作后继续登录,还原操作就是把状态置为正常USER_UNFREEZE
    public static final Integer USER_DISABLE = 4;  //dq add 对应用户禁用状态

    /**密码输入错误最多次数*/
    public static final Integer MAX_WRONG_PASSWORD = 3;
    ...
    public final static String FLOAT = "2";

    /**
     * license监控状态
     */
    public final static String QUEUING = "0";
    public final static String EXECUTING = "1";

    /**
     *客户端任务执行状态（0：排队中 1：执行中 2：执行完毕 3：执行异常）
     */
    ...
    /**
     *Kloc客户端任务执行状态（-1：未执行0：排队中 1：执行中 2：执行完毕）
     */
    public final static String KLOCNORUNING = "-1";
    public final static String KLOCQUE = "0";
    public final static String KLOCRUNING = "1";
    public final static String KLOCCOMPLETE = "2";
    public final static String KLOCSTOP = "3";
    public final static String KLOCERRR = "401";
     ...
     * 虚拟删除0
     */
    public final static String DATA_IDEL_0 = "0";
    public final static Integer DATA_Int_IDEL_0 = 0;
    /**
     * 虚拟删除1 删除
     */
    public final static String DATA_IDEL_1 = "1";
