...
public class YouBianCodeUtil {
	...
	public static final int ZHANG_WEI_LENGTH = 1+NUM_LENGTH;
...
//			org.jeecgframework.core.util.LogUtil.info(afterCode);
//			org.jeecgframework.core.util.LogUtil.info(afterCode_zimu);
//			org.jeecgframework.core.util.LogUtil.info(afterCode_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static String[] cutYouBianCode(String code){
		if(code==null || StringUtil.isNullOrEmpty(code)){
			...
			//获取标准长度为NUM_LENGTH+1,截取的数量为code.length/NUM_LENGTH+1
